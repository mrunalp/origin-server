...
then
  USED_BUNDLER=false
  if [ -d ${OPENSHIFT_RUBY18_TMP_DIR}/.bundle ]
  then
    USED_BUNDLER=true
  fi
  ...
  then
    ...
    mv ${OPENSHIFT_RUBY18_TMP_DIR}/.bundle ${OPENSHIFT_REPO_DIR}
    if [ -d ${OPENSHIFT_REPO_DIR}/vendor ]
    then
      mv ${OPENSHIFT_RUBY18_TMP_DIR}/vendor/bundle ${OPENSHIFT_REPO_DIR}/vendor/
    else
      mv ${OPENSHIFT_RUBY18_TMP_DIR}/vendor ${OPENSHIFT_REPO_DIR}
    fi
    rm -rf ${OPENSHIFT_RUBY18_TMP_DIR}/.bundle ${OPENSHIFT_RUBY18_TMP_DIR}/vendor
  fi
