...
app_userid=`id -u`
httpd_pid=`cat ${OPENSHIFT_RUBY18_RUN_DIR}/httpd.pid 2> /dev/null`
/usr/sbin/httpd -C "Include ${OPENSHIFT_RUBY18_CART_DIR}/conf.d/*.conf" -f $CART_CONF_DIR/httpd_nolog.conf -k $1
for i in {1..20}
do
